...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/capitulos', name: 'capitulos', component: Capitulos },
        { path: '/capitulo/:id', name: 'capitulo', component: Capitulo },
        { path: '/bandos', name: 'bandos', component: Bandos },
        { path: '/curiosidades', name: 'curiosidades', component: Curiosidades },
        { path: '/localicaciones', name: 'localicaciones', component: Localicaciones },
        { path: '/titanes', name: 'titanes', component: Titanes },
        { path: '/lugar/:id', name: 'lugar', component: Lugar },
        { path: '/titan/:id', name: 'titan', component: Titan },
        { path: '/bando/:id', name: 'bando', component: Bando },
    ],
});

const app = createApp(App);

// Registrar Splide globalmente
